...
public final class PhotoDetailsViewController: UIViewController {
    ...
    public var output: PhotoDetailsViewOutput?
...
extension PhotoDetailsViewController: PhotoDetailsViewInput {
    ...
    public func setUpInitialState(title: String) {
    ...
    public func updateState(withViewModel viewModel: PhotoDetailsViewModel) {
