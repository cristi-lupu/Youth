...
final class PhotosCollectionViewListLayout: UICollectionViewLayout {
    ...
    private weak var delegate: PhotosCollectionViewListLayoutDelegate? {
        ...
        for section in 0..<numberOfSections! {
            ...
            if headerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(
                    forSupplementaryViewOfKind: PhotosCollectionViewListElementKindSectionHeader,
            ...
            if footerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(
                    forSupplementaryViewOfKind: PhotosCollectionViewListElementKindSectionFooter,
                    with: IndexPath(item: 0, section: section)
                )
