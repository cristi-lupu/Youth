...
open class PhotosCollectionViewGridLayout: UICollectionViewLayout {
    ...
    fileprivate weak var delegate: PhotosCollectionViewGridLayoutDelegate?  {
        get {
    ...
    override open func prepare() {
        ...
        for section in 0..<numberOfSections! {
            ...
            if headerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: PhotosCollectionViewGridElementKindSectionHeader,
            ...
            if footerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: PhotosCollectionViewGridElementKindSectionFooter,
                                                              with: IndexPath(item: 0, section: section))
